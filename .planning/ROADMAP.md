...
- [x] 04-02-PLAN.md — era-synthesizer agent + `/gitchange` semantic orchestration + JSON schemas
- [x] 04-03-PLAN.md — Deterministic temporal graph assembler → temporal-graph.json

**Wave 3** *(blocked on Wave 2 completion of 04-03)*

- [x] 04-04-PLAN.md — Graph reviewer + semantic integrity + manifest checkpoint + runSemanticPipeline
...
- [x] 05-03-PLAN.md — vis-timeline era markers + era-filtered commits (TIME-01)
...
- [x] 06-02-PLAN.md — decision-miner agent + merge + attribution (DEC-01/02, CONT-02)
- [x] 06-03-PLAN.md — STAT-01 status inferencer + open-work assembly + pipeline
...
- [x] 06-05-PLAN.md — /gitchange-interview loop + durable writeback (DEC-03/04)
...
- [x] 07-01-PLAN.md — Tours schemas + deterministic outline + context bundler + I/O

**Wave 2** *(blocked on Wave 1; parallel)*

- [x] 07-02-PLAN.md — tour-builder agent + merge + pipeline + skill orchestration
...
- [x] 08-01-PLAN.md — SCALE-01: piscina workers, SQLite tuning, progress CLI, 10k benchmark gate
...
- [ ] 09-01-PLAN.md — App-frame + IA rewrite: full-width header, tablist out of sidebar, per-view layouts, centered states
...
| 9. Dashboard UI Redesign | 0/4 | Planning   | — |
