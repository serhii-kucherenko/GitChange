...
- [ ] 06-02-PLAN.md — decision-miner agent + merge + attribution (DEC-01/02, CONT-02)
...
- [ ] 06-05-PLAN.md — /gitchange-interview loop + durable writeback (DEC-03/04)
...
| 6. Decisions, Status & Open Work | 2/6 | In Progress|  |
